...
(function () {
	...
	window.addEventListener('message', async (event) => {
		...
		} else if (event.data.type === 'perchat-style-deleted') {
			const deletedStyleId = event.data.styleId;
